...
<html>
<head>
<title>2021 CTF Scoreboard</title>
...
<body>
<h1>2021 CTF Scoreboard</h1>
<?php
    $deduction = -100;
    $actualtampertoken = "skymanatees";
    $submitkeys = array('vAVmFbYr', 'Nfbi1ptO', 'HYuzM8C9', 'DyQnPdHL', 'pHiNTxuZ', 'x0lr0pjQ', 'Nxitsvhe', 'ukYfr9Nn', 'r9aVjPPq', 'CUQmU4Lw', 'g9beOC4R', '31kUNRRC', 'gqcOxsuD', 'ouolrkkf', 'G18r22t3', 'YUx6am2F', 'CjQ6giMP', '3Xgt0frY', 'dsIsu11j', 'oeykjXYy', 'wGQPWNXv', 'kxMzWtmm', '7SnAnbg2', 'pnNqcZFp', 'RdMDONWn', 'dbirEMHv', 'DT1pjqQD', 'yellowroseoftexas');
    $error = false;
    $success = false;
    $tamper = false;
    if (!empty($_POST)) {
...
<p>Challenge 8: Financial reports in the dump of content. <span class="points">250 points</span></p>
...
<p>Challenge 11: Inside of that Bitcoin... <span class="points">400 points</span></p>
<p>Challenge 12: The Eval Gamestonk Terminal 💎🙌 <span class="points">400 points</span></p>
<h2>Scores</h2>
<table>
<tr>
<th>Team Number</th>
